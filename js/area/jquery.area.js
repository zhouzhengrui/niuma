/*定义三级省市区数据*/
var province = ["北京市", "上海市", "天津市", "河北省", "河南省", "山西省", "山东省", "内蒙古自治区", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "福建省", "江西省", "安徽省", "湖北省", "湖南省", "广东省", "广西壮族自治区", "海南省", "重庆市", "四川省", "贵州省", "云南省", "西藏自治区", "陕西省", "甘肃省", "青海省", "宁夏回族自治区", "新疆维吾尔自治区", "台湾省", "香港特别行政区", "澳门特别行政区"];
var city = [
    ["市辖区"],
    ["市辖区", "市辖县"],
    ["市辖区", "市辖县"],
...
var areaExpress, areaCont, areaList = $("#area-list"),
...
function selectD(p, c, d) {
    clockArea();
    $("#area-select p").removeClass("gray");
...
/*关闭省市区选项*/
function clockArea() {
    $('#modal-area').removeClass('md-show');
    intProvince();
}
